...
mkdir -p fresh_results/qualm_bench

mkdir -p fresh_results/qualm_bench/nam
mkdir -p fresh_results/qualm_bench/nam/guoq
mkdir -p fresh_results/qualm_bench/nam/voqc
mkdir -p fresh_results/qualm_bench/nam/qiskit
mkdir -p fresh_results/qualm_bench/nam/queso
mkdir -p fresh_results/qualm_bench/nam/qualm

######## Running tests on Nam gate set"

BENCHMARK_DIR="qualm"
echo "Running experiments on qualm circuits with Nam gate set:"
...
mv results_* fresh_results/qualm_bench/nam/guoq

run_qiskit $BENCHMARK_DIR/$benchmark $timeout "nam"
mv results_* fresh_results/qualm_bench/nam/qiskit
...
mv results_* fresh_results/qualm_bench/nam/queso


run_voqc $BENCHMARK_DIR/$benchmark $timeout "nam"
mv results_* fresh_results/qualm_bench/nam/voqc
